...
const MediaDropDown = () => {
    ...
    const handleSendImage = async () => {
      setIsLoading(true);
      try {
        //Paso 1: Obtener la URL para subir la imagen
        const postUrl = await generateUploadUrl();
        //Paso 2: POST de la imagen en la url
        ...
        // Paso 3: Guardar la Id de almacenamiento recién asignada en la base de datos
...
const MediaVideoDialog = ({ isOpen, onClose, selectedVideo, isLoading,handleSendVideo }: MediaVideoDialogProps) => {const renderedVideo = URL.createObjectURL(new Blob([selectedVideo], { type: "video/mp4"}));
